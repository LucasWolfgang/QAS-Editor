...
%amc2moodle \SetOption{imgResolution}{72}  
    \begin{center}
      \includegraphics[width=0.5\textwidth]{./amc_schema_interpL.png}
    \end{center}
...
\element{cat2}{
  \begin{questionmult}{Qmult:TabVerbMacro}
    ...
    \begin{reponses}
      ...
      \mauvaise{la réponse en image \includegraphics[height=16pt]{./amc_4r.png}}
      \mauvaise{$6\times 6$}
...
\element{english}{
  \begin{question}{prez}
    ...
    \begin{choiceshoriz}
      ...
      \wrongchoice{with an image \includegraphics[height=16pt]{./amc_4r.png}}
    \end{choiceshoriz}
  \end{question}
}
