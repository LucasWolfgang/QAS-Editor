...
\usepackage[francais,bloc,completemulti]{sty/automultiplechoice}
\usepackage{tikz}
\usepackage{hyperref}
...
\element{moodle2amc}{
  \begin{question}{html layout}\label{q:html layout}   
    a link \href{https://github.com/nennigb/amc2moodle}{here } and an image \includegraphics[]{src/4.png} and an equation \( \int_{2\pi} x^2 \mathrm{d} x \)
